...
import { AlertCircle, CheckCircle2, ChevronRight, Clock3, ExternalLink, File, FileText, Pencil, Plus, Trash2, X } from 'lucide-react'
import { service } from './service'
import { roleLabels, statusLabels } from './types'
import type { Assignment, Course, FileAsset, FileLink, FileRole, Status } from './types'
...
export function AssignmentDetail({ item, course, links, files, onEdit, onDelete, onAddFile, onEditLink, onRename, onStatus, onRelink }: { item: Assignment; course?: Course; links: FileLink[]; files: FileAsset[]; onEdit: () => void; onDelete: () => void; onAddFile: (role: FileRole) => void; onEditLink: (link: FileLink) => void; onRename: (link: FileLink) => void; onStatus: (status: Status) => void; onRelink: (file: FileAsset) => void }) {
